...
curl -fsSL https://raw.githubusercontent.com/marcospedro97/dotfiles/master/zshrc -o "$HOME/.zshrc"
...
curl -fsSL https://raw.githubusercontent.com/marcospedro97/dotfiles/master/tmux.conf -o "$HOME/.tmux.conf"
...
curl -fsSL https://raw.githubusercontent.com/marcospedro97/dotfiles/master/watch-rsync.sh -o "$HOME/.scripts/watch-rsync.sh"
curl -fsSL https://raw.githubusercontent.com/marcospedro97/dotfiles/master/rsync-watcher.service -o "$HOME/.config/systemd/user/rsync-watcher.service"
